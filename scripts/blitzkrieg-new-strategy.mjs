...
mod tests {
    ...
    /// smoke-tested against the real kernel by \`npm run strategy:devcheck\`).
    #[test]
    fn buys_the_dip() {
...
console.log('next: npm run strategy:devcheck   (builds it and verifies against a real dry core)');
