...
//!
//! Prices/sizes cross IPC as JSON numbers (Node) or strings (Polymarket/Rust).
//! Monetary arithmetic inside the core uses `rust_decimal::Decimal`; the boundary
//! decodes both forms via these serde functions.
