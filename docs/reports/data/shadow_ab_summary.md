...
final_params_vs_initial_max_entry_cap: 0.4365 -> 0.4365

## Group B parameter trajectory (changed fields only)
ts,field,from,to,reason,applied,rejection
1700000868000,trend_max_entry_price,0.45,0.4365,CombinedImprovement,true,
...
final_cap: 0.4365  final_min_price: 0.55
trajectory:
  applied=true reason=CombinedImprovement trend_max_entry_price:0.45->0.4365
